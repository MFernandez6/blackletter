...
/** Standard letter page margin — preview, print, and Google Docs. */
export const LETTER_PAGE_MARGIN = "1in";
...
<head>
  ...
  <style>
    @page { margin: ${LETTER_PAGE_MARGIN}; }
    html, body { background: #f4efe4; margin: 0; padding: 0; }
    body {
